import sys, os
sys.path.append(os.path.abspath('./src/playercard_generation/'))
from dimensions.Fifa19StandardDimensions import Dimensions as fifa19_standard_dimensions
from dimensions.Fifa19UclDimensions import Dimensions as fifa19_ucl_dimensions
