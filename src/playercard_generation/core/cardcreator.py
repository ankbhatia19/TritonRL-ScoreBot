...
def stamp_country_flag_and_club_badge(card_obj, card_bg_img, player):
    ...
    if player.country == 'trl':
        country_flag_img_width = 200
        country_flag_img_height = 200
    else:  
    ...
    club_badge_img_width = club_badge_img_width + 20
    club_badge_img_height = club_badge_img_height + 20
